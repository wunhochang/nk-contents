...
namespace GAPI.Common
{
    ...
    {
        SqlConnection _conn = null;//new MySqlConnection();

        private string connectString;

        ILogger _logger { get; } = Logging.CreateLogger<IDatabase>();

        public MSSQLDB(string connectString)
        {
        ...
        private void Open()
        {
            _logger.LogDebug("MSSql DB Open. connect string = {0}", connectString);
        ...
        private void Close()
        {
            _logger.LogDebug("MSSql DB Close. connect state = {0}", _conn.State);
        ...
        public void Dispose()
        {
            _logger.LogDebug("MSSql DB Dispose.");
        ...
        public decimal ExcuteSQL(String query, Hashtable parameters = null)
        {
            try
            {
                ...
                _logger.LogDebug("MSSQL ExcuteSQL. SQL={0}, Params={2}", query, JsonConvert.SerializeObject(parameters));
        ...
        public List<Hashtable> GetDataTable(String query, Hashtable parameters = null)
        {
            try
            {
                ...
                _logger.LogDebug("MSSQL GetDataTable. SQL={0}, Params={2}", query, JsonConvert.SerializeObject(parameters));
        ...
        private void FillParameter(String query, Hashtable parameters, SqlCommand command)
        {
        ...
        public decimal GetNextSeq(string tableName)
        {
            ...
            var query = "EXEC DBO.USP_GET_NEXTVAL '" + tableName.ToUpper() + "'";
