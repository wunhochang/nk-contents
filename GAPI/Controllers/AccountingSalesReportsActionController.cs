...
{
    [Route("api/AccountingSalesReport/[action]")]
    public class AccountingSalesReportActionController : GController
    {
        private const string XlsxContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        private readonly IHostingEnvironment _hostingEnvironment;

        private new APIResult result = new APIResult();
        public AccountingSalesReportActionController(IHostingEnvironment hostingEnvironment)
        {
        ...
        public APIResult GetList(string condition, int page, int start, int limit, [FromQuery]string sort)
        {
            try
            {
                ...
                AccountingSalesReports.GetList(hsCondition, ref result);
        ...
        public APIResult GetYearList(string condition, int page, int start, int limit, [FromQuery]string sort)
        {
            try
            {
                ...
                var hsCondition = new Hashtable();
                AccountingSalesReports.GetYearList(hsCondition, ref result);
