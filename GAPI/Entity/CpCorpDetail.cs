...
{
    public class CpCorpDetail : Gentity
    {
      internal static void GetList(Hashtable condition, ref APIResult result)
      {
          try
          {
              ...
              {
                    var sql = DB.GetQuery("cp_corp_detail", "GetList", condition);
        ...
        internal static void GetPrepayList(Hashtable condition, ref APIResult result)
      {
          try
          {
              var data = new Hashtable();
              using (var DB = Config.GetDatabase())
              {
                    var sql = DB.GetQuery("cp_corp_detail", "GetPrepayList", condition);
