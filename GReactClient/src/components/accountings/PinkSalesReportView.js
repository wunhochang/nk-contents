...
export default class PinkSalesReportView extends Component {
  state = {
  ...
  store = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        ...
        url: `${API_URL}/AccountingSummary/GetPinkSalesReport`,
        actionMethods: {
            read: "GET"
        },
        extraParams: {
  ...
  onClickExcelDownload = (item) =>{
    const me = this,
      ...
      grid = header_grid.down('grid'),
      ExcelName = '핑크무비매출현황',
      url = 'GetPinkSalesReportExcelDownload';
