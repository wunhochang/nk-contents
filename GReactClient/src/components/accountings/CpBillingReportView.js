...
import CpAccountsCancelFormView from './CpAccountsCancelFormView';
...
export default class CpBillingReportView extends Component {
  state = {
    isOpen:false,
           ...
           items={[{
            ...
            //  },
             ...
             tbar:[{
               ...
               {
                 xtype:'button',
                 text:'<font color=white>CP사 업체별정산취소</font>',
                 cls:'base-button-round',
                 style: {
                     'font-size': '14px',
