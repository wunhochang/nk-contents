          ...
          showConfirm({
              ...
              callback: function () {
                Ext.each(selection, function (itm) {
                  if(!(itm.data.movie_no == 0 || itm.data.movie_no == '' || itm.data.movie_no ==  null)){
                    promiseList.push(new Ext.Promise(function (res) {
                      Ext.Ajax.request({
                          url: `${API_URL}/Movie/Delete/`+itm.data.movie_no,
                          method: 'DELETE',
             ...
             tbar:[{
               ...
               columns:[
                 ...
                 },
                 {
                      ...
                      style:'text-align:center',
                      renderer: function(value, metaData, record) {
                        var deviceDetail = record.get('cp_corp_no_name');
                        metaData.tdAttr = 'data-qtip="' + deviceDetail + '"';
                        return value;
                      }
                 },
